...
In the chart below, we see that the percent of unhoused folks that are unsheltered has varied over time. Though it appeared to be decreasing since 2007, there's been a noticeable increase since the onset of the Covid-19 pandemic in the US in 2020. This variability motivates the question of whether shelter bed availability is responsive to need, based on the prevalence of homelessness.
...
mult_fit
```
```{r, boston-unsheltered trend}
boston_PIT_count_over_time <- PIT_count |>
  group_by(year) |>
